...
public class TelaRoom extends javax.swing.JFrame {
   ...
   private int saida;
    ...
    private boolean goRoom(String direction) 
    {
        ...
        if (nextRoom == null) {
            ...
            if(currentRoom.getExistemonstro()){
                Monstro m1=colecao.pesquisar(currentRoom.getIndicemonstro());  
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 60, 120));
        ...
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 110, 130, 50));
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 400, -1, -1));
